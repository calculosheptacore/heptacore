        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="calcularEquipos">Calcular equipos </a></li>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="d-grid gap-2 d-md-block">
                  ...
                  <button type="button" class="btn btn-azulHepta" id="mostrarDatosSalida" >
                    Realizar cálculo  
                  </button>
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                          ...
                          <div class="container-fluid">
                            <div class="row">
                              <div class="col-12">
                                ...
                                <div class="card">
                                  <div class="card-header">
                                    <h3 class="card-title">Condiciones de planta</h3>
                        ...
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-12">
                              ...
                              <div class="card">
                                <div class="card-header">
                                  <h3 class="card-title">Caracterización de material</h3>
                        ...
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-12">
                              ...
                              <div class="card">
                                <div class="card-header">
                                  <h3 class="card-title">Aerodeslizador</h3>
                    ...
                    <!--<div class="d-grid gap-2 d-md-block">
                      <button type="button" class="btn btn-azulHepta btn-lg btn-block" data-toggle="modal" data-target="#DatosSalida" id="mostrarDatosSalida">
                        Realizar cálculo 
                      </button>-->
                    </div>
              </div>
...
<div class="modal fade selectControlTiempos " id="DatosSalida" data-backdrop="static" data-keyboard="false"  aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Aerodeslizador&nbsp;-&nbsp;</h3> <h3 class="card-title" id="CodigoAerodeslizador"></h3>
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">ventilador&nbsp;-&nbsp;</h3> <h3 class="card-title" id="CodigoVentilador"></h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" >
            <div class="input-group mb-3">
              <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#DetalleDatosSalida">Calculo detallado</button>
            </div>
          </div>

          <div class="col-lg-6" >
            <div class="input-group mb-3">
              <button type="submit" class="btn btn-azulHepta btn-block ">Guardar</button>
            </div>
          </div> 

        <?php

          $crearCularAerodeslizador = new calcularAerodeslizador();
          $crearCularAerodeslizador -> ctrCrearcalCularAerodeslizador();
...
<div class="modal fade selectControlTiempos" id="DetalleDatosSalida" data-backdrop="static" data-keyboard="false"  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl  ">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #2a3c6b">
        <h5 class="modal-title" style="color: white;" id="staticBackdropLabel">CALCULO DETALLE</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" class="clearModGuardarPlanta" style="color: white;">&times;</span>
        </button>
      </div>
    ...
    <section class="content">
                      ...
                      <label for="exampleInputFile">País</label>
                       <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            ...
                            <select class="form-control input-lg" id="PaisDetalle" name="PaisDetalle" disabled>
                      ...
                      <label for="exampleInputFile">Planta</label>
                       <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            ...
                            <select class="form-control input-lg" id="PlantaAerodeslizador" name="PlantaAerodeslizador" disabled>
                    ...
                    <div class="col-lg-4">
                      <label for="exampleInputFile">Código del equipo</label>
                       <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control UserName" placeholder="0 " aria-label="" id="" name="" aria-describedby="basic-addon1"  disabled>
                        </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger clearModGuardarPlanta"  data-dismiss="modal">Cerrar</button>
...
<!-- Modal de carga -->
<div class="modal fade" id="ModalCargarCalculo" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
